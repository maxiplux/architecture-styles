...
public class DataInitializer implements CommandLineRunner {
    ...
    private void initializeData() {
        ...
        createProduct(
                ...
                12,
                "https://example.com/images/asus-rog.jpg",
                laptops
        );
        ...
        createProduct(
                ...
                new BigDecimal("1349.99"),
                30,
                "https://example.com/images/thinkpad-x1.jpg",
                laptops
        );
        ...
        createProduct(
                ...
                20,
                "https://example.com/images/hp-pavilion.jpg",
                desktops
        );

        createProduct(
                "Custom Gaming PC - RTX 4080",
                "High-end gaming desktop with Intel Core i9, 64GB RAM, 2TB NVMe SSD, RTX 4080, RGB lighting",
                new BigDecimal("3499.99"),
                8,
                "https://example.com/images/gaming-pc-4080.jpg",
                desktops
        );
        ...
        createProduct(
                ...
                18,
                "https://example.com/images/imac-24.jpg",
                desktops
        );
        ...
        createProduct(
                ...
                35,
                "https://example.com/images/ryzen-9-7950x.jpg",
                components
        );
        ...
        createProduct(
                ...
                50,
                "https://example.com/images/corsair-vengeance-ddr5.jpg",
                components
        );
        ...
        createProduct(
                ...
                28,
                "https://example.com/images/asus-rog-mobo.jpg",
                components
        );
        ...
        createProduct(
                ...
                40,
                "https://example.com/images/evga-psu-850w.jpg",
                components
        );
        ...
        createProduct(
                ...
                45,
                "https://example.com/images/corsair-k95.jpg",
                peripherals
        );
        ...
        createProduct(
                ...
                32,
                "https://example.com/images/dell-ultrasharp-27.jpg",
                peripherals
        );
        ...
        createProduct(
                ...
                20,
                "https://example.com/images/lg-ultrawide-34.jpg",
                peripherals
        );
        ...
        createProduct(
                ...
                new BigDecimal("99.99"),
                55,
                "https://example.com/images/hyperx-cloud-ii.jpg",
                peripherals
        );
        ...
        createProduct(
                ...
                80,
                "https://example.com/images/usbc-hub.jpg",
                accessories
        );

        createProduct(
                "AmazonBasics HDMI Cable 6ft",
                "High-speed HDMI 2.0 cable supporting 4K@60Hz, Ethernet, and ARC",
                new BigDecimal("12.99"),
                150,
                "https://example.com/images/hdmi-cable.jpg",
                accessories
        );

        createProduct(
                "Anker PowerPort USB Charger",
                "6-port USB charging station with 60W total output, PowerIQ technology",
                new BigDecimal("39.99"),
                70,
                "https://example.com/images/anker-powerport.jpg",
                accessories
        );
        ...
        createProduct(
                ...
                65,
                "https://example.com/images/belkin-surge.jpg",
                accessories
        );
        ...
        createProduct(
                ...
                new BigDecimal("129.99"),
                45,
                "https://example.com/images/samsung-990-pro.jpg",
                storage
        );
        ...
        createProduct(
                ...
                38,
                "https://example.com/images/wd-black-4tb.jpg",
                storage
        );
        ...
        createProduct(
                ...
                new BigDecimal("129.99"),
                50,
                "https://example.com/images/seagate-backup-5tb.jpg",
                storage
        );
        ...
        createProduct(
                ...
                42,
                "https://example.com/images/sandisk-extreme-2tb.jpg",
                storage
        );
    }
